      ...
      <div>
        <div className="flex gap-12 my-12">
          <Link
            ...
            className={`!bg-cover bg- bg-no-repeat border border-4 border-solid border-gray-100 rounded-lg w-[300px] h-[400px] relative`}
          >
          ...
          <Link
            ...
            className={` !bg-cover bg-no-repeat border border-4 border-solid border-gray-100 rounded-lg  w-[300px] h-[400px] relative `}
          >
            <span className="text-4xl text-green-700 hover:text-gray-100 font-bold absolute right-[10px] bottom-[10px]">
              Websites
            </span>
